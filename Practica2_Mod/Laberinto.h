...
class Laberinto {
 public:
  ...
  void MostrarLaberinto(const std::vector<Nodo*>& nodos_abiertos, const std::vector<Nodo*>& nodos_cerrados, const std::vector<Nodo*>& camino);
  ...
  void DesmarcarCamino(const std::vector<Nodo*>& camino);
